#---------------------------------------------------------------------
# ChangePopPwd.pm
# Last Modification: 2001/07/27 (hdias@esb.ucp.pt)
#
...
# POD Documentation (perldoc ChangePopPwd or pod2html this_file)

=head1 NAME

Mail::ChangePopPwd - Perl 5 module to talk to a poppasswd daemon

=head1 SYNOPSIS

  use Mail::ChangePopPwd;

  my $poppwd = Mail::ChangePopPwd->new(
                        HOST   => "localhost",
                        USER   => "hdias",
                        OLDPWD => "********",
                        NEWPWD => "********");
